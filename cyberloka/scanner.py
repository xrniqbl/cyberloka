...
MODULE_MAP: dict[str, str] = {
    ...
    # ===== NEW (v0.9.2) =====
    "secrets_scanner": "cyberloka.passive.secrets_scanner",
    "waf_detect": "cyberloka.passive.waf_detect",
    "tabnabbing": "cyberloka.passive.tabnabbing",
    "well_known_audit": "cyberloka.passive.well_known_audit",
    "json_csrf": "cyberloka.active.json_csrf",
    "prompt_injection": "cyberloka.active.prompt_injection",
    "admin_panel_finder": "cyberloka.active.admin_panel_finder",
    "secrets_in_response_diff": "cyberloka.active.secrets_in_response_diff",
    "cors_credentials_probe": "cyberloka.active.cors_credentials_probe",
