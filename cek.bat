...
title Cyberloka v0.10.5 - Web Vulnerability Scanner
chcp 65001 >nul 2>&1
...
cls
echo ======================================================================
echo   CYBERLOKA v0.10.5 - Web Vulnerability Scanner (strict validation)
echo ======================================================================
echo.
...
echo    7. Daftar semua module deteksi  ^(135+ modul, termasuk 30 baru^)
